...
playerturn=ttk.Label(root,text="   Joueur '1' commence la partie   ")
playerturn.grid(row=3,column=0,sticky='snew',ipadx=40,ipady=40)
playerdetails=ttk.Label(root,text="    Joueur'1' est 'X'  ,  Joueur'2' est 'O' ")
...
def restartbutton():
    ...
    b=0
    c=0
    playerturn['text']="   Joueur 1 commence   "
    bu1['text']=' '
    bu2['text']=' '
    bu3['text']=' '
    bu4['text']=' '
...
def ButtonClick(id):
    ...
    if( bu1['text']=='X' and bu2['text']=='X' and bu3['text']=='X' or
        ...
        bu3['text']=='X' and bu5['text']=='X' and bu7['text']=='X'):
            disableButton()
            c=1
            tkinter.messagebox.showinfo("X/O","le Joueur '1' a gagné")
          ...
          bu3['text']=='O' and bu5['text']=='O' and bu7['text']=='O'):
            disableButton()
            c=1
            tkinter.messagebox.showinfo("X/O","le Joueur '2' a gagné")
    elif  b==9:
            disableButton()
            c=1
            tkinter.messagebox.showinfo("X/O","match nul")
root.mainloop()